...
export default function SerieCard({ serie }: Props) {
  ...
  return (
    <div className="drop-shadow-xl bg-white p-[10px] rounded-xl flex flex-col w-6/6 md:w-5/6 mx-auto">
      <h3 className="text-lg text-black"><b>Title: </b>{title}</h3>
      ...
      <Image
        ...
        height={100}
        blurDataURL={
          "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP0dvKuBwADEQFZ9IFvHwAAAABJRU5ErkJggg=="
        }
      />
      ...
      <button className="bg-blue-500 text-white px-[15px] py-[8px] mt-[8px] rounded-md md:w-3/6 w-6/6 self-end">
        Go to serie
      </button>
    </div>
  );
